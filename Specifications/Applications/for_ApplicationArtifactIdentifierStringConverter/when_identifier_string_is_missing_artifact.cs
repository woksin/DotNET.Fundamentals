...
{
    public class when_identifier_string_is_missing_artifact : given.an_ApplicationArtifactIdentifierStringConverter
    {
        ...
        It should_throw_missing_application_artifact_generation = () => exception.ShouldBeOfExactType<MissingApplicationArtifact>();
